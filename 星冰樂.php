...
<nav class="navbar navbar-expand-sm navbar-dark" style="background-color: #6a381f;">
  ...
  <div class="card" style="width:400px">
    <img class="card-img-top" src="星冰樂.jpg" alt="Card image" style="width:100%">
    <div class="card-body">
      <h4 class="card-title">星冰樂</h4>
	  <h2>介紹</h2>
      <p class="card-text">這款經典的星冰樂是為了讓咖啡愛好者在夏天也能盡情享用咖啡而發明的。綿密口感及獨特咖啡香氣，讓它歷久彌新。</p>
	  <?php error_reporting(0); ?>
            <?php
            $pdo=new PDO('mysql:host=localhost;dbname=shop;charset=utf8' , 'yucheng', 'coffeeshop');
            $sql=$pdo->prepare('select * from products where id=8');
            $sql->execute($id);
