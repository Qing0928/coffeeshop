...
<nav class="navbar navbar-expand-sm navbar-dark" style="background-color: #6a381f;">
  ...
  <div class="card" style="width:400px">
    <img class="card-img-top" src="冰拿鐵.jpg" alt="Card image" style="width:100%">
    <div class="card-body">
      <h4 class="card-title">冰拿鐵</h4>
	  <h2>介紹</h2>
      <p class="card-text">咖啡與鮮奶的完美調合，鮮奶濃郁烘托咖啡甘醇，湧現清爽輕盈口感，是炎夏裡沁涼入心的幸福風味。</p>
      <?php error_reporting(0); ?>
          <?php
          $pdo=new PDO('mysql:host=localhost;dbname=shop;charset=utf8' , 'yucheng', 'coffeeshop');
          $sql=$pdo->prepare('select * from products where id=1');
          $sql->execute($id);
