...
<nav class="navbar navbar-expand-sm navbar-dark" style="background-color: #6a381f;">
  ...
  <div class="card" style="width:400px">
    <img class="card-img-top" src="咖啡凍.jpg" alt="Card image" style="width:100%">
    <div class="card-body">
      <h4 class="card-title">咖啡凍</h4>
	  <h2>介紹</h2>
      <p class="card-text">想吃點心的時候吃咖啡凍，可以解解饞，外面賣的咖啡凍都太甜了，用洋菜粉來做個無糖的咖啡凍，要吃的時候加一小匙蜂蜜及適量牛奶就是很有飽足感的甜點了~</p>
	  <?php error_reporting(0); ?>
            <?php
            $pdo=new PDO('mysql:host=localhost;dbname=shop;charset=utf8' , 'yucheng', 'coffeeshop');
            $sql=$pdo->prepare('select * from products where id=3');
            $sql->execute($id);
