...
<nav class="navbar navbar-expand-sm navbar-dark" style="background-color: #6a381f;">
  ...
  <div class="card" style="width:400px">
    <img class="card-img-top" src="卡布奇諾.jpg" alt="Card image" style="width:100%">
    <div class="card-body">
      <h4 class="card-title">卡布奇諾</h4>
	  <h2>介紹</h2>
      <p class="card-text">義大利濃縮咖啡(Espresso)為基底，加入大量新鮮牛奶，高溫蒸氣加熱誘發奶香更加濃郁撲鼻，口感圓潤滑順，
	  細細品嚐其細緻圓柔的絕妙滋味，不論任何季節飲用皆能感受微甜的幸福感。</p>
	  <p class="card-text"></p>
      <?php error_reporting(0); ?>
            <?php
            $pdo=new PDO('mysql:host=localhost;dbname=shop;charset=utf8' , 'yucheng', 'coffeeshop');
            $sql=$pdo->prepare('select * from products where id=2');
            $sql->execute($id);
