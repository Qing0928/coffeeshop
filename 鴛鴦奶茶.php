...
<nav class="navbar navbar-expand-sm navbar-dark" style="background-color: #6a381f;">
  ...
  <div class="card" style="width:400px">
    <img class="card-img-top" src="鴛鴦奶茶.jpg" alt="Card image" style="width:100%">
    <div class="card-body">
      <h4 class="card-title">鴛鴦奶茶</h4>
	  <h2>介紹</h2>
      <p class="card-text">鴛鴦奶茶是香港特產飲品，常見於香港的茶餐廳。 製法是混合了一半的咖啡和一半的絲襪奶茶，同時集合有咖啡的香味，和奶茶的濃滑。
	  飲用者可以自行加糖，也可以叫店裡事先加入煉乳。 鴛鴦起源自香港的大排檔。</p>
	  <?php error_reporting(0); ?>
            <?php
            $pdo=new PDO('mysql:host=localhost;dbname=shop;charset=utf8' , 'yucheng', 'coffeeshop');
            $sql=$pdo->prepare('select * from products where id=10');
            $sql->execute($id);
