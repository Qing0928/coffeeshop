...
<nav class="navbar navbar-expand-sm navbar-dark" style="background-color: #6a381f;">
  ...
  <div class="card" style="width:400px">
    <img class="card-img-top" src="手沖咖啡.jpg" alt="Card image" style="width:100%">
    <div class="card-body">
      <h4 class="card-title">手沖咖啡</h4>
	  <h2>介紹</h2>
      <p class="card-text">手沖咖啡顧名思義，就是將熱水倒在咖啡粉上，經由濾紙和濾杯萃取出咖啡，整個沖煮過程約3至4分鐘。
	  由於熱水的流速、方向、溫度皆由沖煮者控制，因此幾乎每次沖煮出來的咖啡風味都不同，雖然器具簡單，卻非常講究手法和經驗。</p>
	  <?php error_reporting(0); ?>
            <?php
            $pdo=new PDO('mysql:host=localhost;dbname=shop;charset=utf8' , 'yucheng', 'coffeeshop');
            $sql=$pdo->prepare('select * from products where id=6');
            $sql->execute($id);
