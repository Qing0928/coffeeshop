...
<nav class="navbar navbar-expand-sm navbar-dark" style="background-color: #6a381f;">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar" >
    <ul class="navbar-nav navlihoverbg" >
      ...
      <li class="nav-item" >
        <a class="nav-link" href="../products.php" style="color: #ffffb3">商品頁</a>
      </li>
      <li class="nav-item">
...
<div class="container-fluid" style="height: 600px; background-image: url('images/中間背景.jpg');  background-repeat: no-repeat; background-size: cover;">
	<?php
	session_start();
	...
	foreach($sql->fetchALL() as $row){
		$_SESSION['customer']=[
			...
			'login'=>$row['login'], 'password'=>['password']];
	}
	if(isset($_SESSION['customer'])){
		echo '<p>',$_SESSION['customer']['name'], '您好'.'</p>';
		echo '2秒後自動跳轉';
	}
	else{
		echo '<p>帳號或密碼錯誤</p>';
